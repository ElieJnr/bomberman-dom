...
export function initGame(){
    ...
    let input=VDOM.createElement("div",{id:"inputContainer"},VDOM.createElement("img",{id:"imgInput",src:"../assets/inputimg.svg"}),VDOM.createElement("input", {type:"text", id:"inputfield"}))
    let playerContainer=VDOM.createElement("div",{id:"playerContainer"},VDOM.createElement("img",{src:"../assets/player.svg", id:"playerimf"}))
